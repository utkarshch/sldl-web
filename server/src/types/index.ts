// Re-exported from shared/types — keep in sync with ../../shared/types/index.ts
...
export type ParsedEvent =
  | { type: "searching"; track: string }
  | { type: "found"; track: string; user: string; file: string }
  | { type: "downloading"; track: string; progress: number; speed?: string }
  | { type: "completed"; track: string; path: string }
  | { type: "failed"; track: string; reason: string }
  | { type: "skipped"; track: string; reason: string }
